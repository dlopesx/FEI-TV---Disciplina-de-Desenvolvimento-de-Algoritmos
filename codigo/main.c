...
void menu_playlists(char *usernamecpy){
    ...
    printf(
        "\nSelecione uma op��o:\n"
        "\n[ 1 ] - Adicionar filme em lista de reprodu��o\n"
        "[ 2 ] - Remover filme de lista de reprodu��o\n"
        "[ 3 ] - Voltar\n"
        "Sua op��o: "
    );
    while (1){
...
void menu_principal(char *usernamecpy){
    ...
    while (1){
        ...
        case '1':
            ...
            break;
        case '2': 
            printf("Você selecionou: [ 2 ] - Criar lista de reproducao de filmes\n");
            printf("\n");
            criar_lista(usernamecpy);
            break;
        case '3':
            printf("Você selecionou: [ 3 ] - Deletar lista de reproducao\n");
            printf("\n");
            if (mostrar_playlists(usernamecpy) == 1){
                break;
            }
            ...
            break;
        case '4':
            printf("Você selecionou: [ 4 ] - Acessar listas de reproducao\n");
            printf("\n");
            if (mostrar_playlists(usernamecpy) == 1){
                break;
            }
